...
# Crear instancia del gestor para materias
...
def abrir_ventana(opcion, ventana_actual):
    ...
    if opcion == "agregar":
        from gui_materia_agregar import mostrar_formulario_agregar_materia
        ...
        from gui_materia_actualizar import mostrar_formulario_actualizar_materia
        mostrar_formulario_actualizar_materia(gestor)
    elif opcion == "eliminar":
        from gui_materia_eliminar import mostrar_formulario_eliminar_materia
        mostrar_formulario_eliminar_materia(gestor)
    elif opcion == "inorden":
        from gui_materia_mostrar_inorden import mostrar_materias_inorden
        mostrar_materias_inorden(gestor)
    elif opcion == "arbol":
        from gui_materia_mostrar_arbol import mostrar_arbol_avl_materias
