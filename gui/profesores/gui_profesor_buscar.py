...
def abrir(tipo, ventana, gestor):
    ventana.destroy()
    if tipo == "codigo":
        from gui.profesores.gui_profesor_buscar_codigo import mostrar_busqueda_por_codigo
        mostrar_busqueda_por_codigo(gestor)
    elif tipo == "nombre":
        from gui.profesores.gui_profesor_buscar_nombre import mostrar_busqueda_por_nombre
        mostrar_busqueda_por_nombre(gestor)
    elif tipo == "correo":
        from gui.profesores.gui_profesor_buscar_correo import mostrar_busqueda_por_correo
        mostrar_busqueda_por_correo(gestor)
    elif tipo == "vinculacion":
        from gui.profesores.gui_profesor_buscar_vinculacion import mostrar_busqueda_por_vinculacion
