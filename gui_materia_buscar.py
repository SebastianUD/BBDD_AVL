...
def abrir_sub_busqueda(campo, gestor, ventana_actual):
    ...
    if campo == "codigo":
        from gui_materia_buscar_codigo import mostrar_busqueda_codigo_materia
        mostrar_busqueda_codigo_materia(gestor)
    elif campo == "nombre":
        from gui_materia_buscar_nombre import mostrar_busqueda_nombre_materia
        mostrar_busqueda_nombre_materia(gestor)
    elif campo == "creditos":
        from gui_materia_buscar_creditos import mostrar_busqueda_creditos_materia
        mostrar_busqueda_creditos_materia(gestor)
    elif campo == "horas_semanales":
        from gui_materia_buscar_horas import mostrar_busqueda_horas_materia
